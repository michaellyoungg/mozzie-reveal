...
export default function BreedPercentageRound({ availableBreeds }: BreedPercentageRoundProps) {
  ...
  return (
    <>
      <div className="bg-linear-to-br from-blue-50 to-blue-100 border-[3px] border-blue-500 rounded-2xl md:rounded-[20px] p-4 md:p-6 mb-6 md:mb-8">
      ...
      <div className="my-6 md:my-8">
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] md:grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-3 md:gap-4">
          {remainingBreeds.map(breed => (
            <button
              key={breed}
              className="min-h-[44px] py-3 md:py-5 px-3 md:px-4 bg-linear-to-br from-gray-100 to-gray-200 border-[3px] border-transparent rounded-xl md:rounded-2xl text-sm md:text-base font-semibold cursor-pointer transition-all duration-300 text-center text-gray-700 active:scale-95 md:hover:bg-linear-to-br md:hover:from-green-500 md:hover:to-green-600 md:hover:text-white md:hover:border-green-700 md:hover:-translate-y-1 md:hover:scale-[1.03] md:hover:shadow-[0_8px_20px_rgba(16,185,129,0.3)]"
