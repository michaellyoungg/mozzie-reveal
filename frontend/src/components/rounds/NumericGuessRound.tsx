...
export default function NumericGuessRound({ unit }: NumericGuessRoundProps) {
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 max-w-[500px] mx-auto">
      <div className="flex items-center justify-center gap-3 md:gap-4 bg-gradient-to-br from-pink-100 to-purple-100 p-6 md:p-8 rounded-2xl md:rounded-[20px] shadow-md md:shadow-[0_4px_16px_rgba(108,91,123,0.15)]">
        <input
          type="number"
          value={value}
      ...
      <input
        ...
        className="w-full h-4 md:h-3 rounded-[10px] bg-gradient-to-r from-pink-100 to-party-purple outline-none appearance-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-9 [&::-webkit-slider-thumb]:h-9 md:[&::-webkit-slider-thumb]:w-8 md:[&::-webkit-slider-thumb]:h-8 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-gradient-to-br [&::-webkit-slider-thumb]:from-party-pink [&::-webkit-slider-thumb]:to-party-purple [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-md md:[&::-webkit-slider-thumb]:shadow-[0_4px_12px_rgba(255,107,157,0.4)] [&::-webkit-slider-thumb]:transition-all [&::-webkit-slider-thumb]:duration-200 [&::-webkit-slider-thumb]:active:scale-110 md:[&::-webkit-slider-thumb]:hover:scale-120 md:[&::-webkit-slider-thumb]:hover:shadow-[0_6px_16px_rgba(255,107,157,0.6)]"
      />
      <button
